...
use Ways\GatewayPayment\Exceptions\ValidationException;
use Ways\GatewayPayment\Entities\PaymentResponse;
...
abstract class BaseGateway implements PaymentGatewayInterface
{
     ...
     * 
     * @var \Ways\GatewayPayment\Core\PaymentLogger
     */
    protected $logger;
     ...
     * @throws \Ways\GatewayPayment\Exceptions\ConfigurationException Se as configurações forem inválidas
     */
     ...
     * @throws \Ways\GatewayPayment\Exceptions\ValidationException Se os dados forem inválidos
     */
     ...
     * @param \Ways\GatewayPayment\Entities\PaymentResponse $response Resposta da transação
     */
